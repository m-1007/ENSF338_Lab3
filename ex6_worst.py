...
# Step 6: Redo with worst-case input for quicksort
worst_case_input = list(range(10000, 0, -1))
worst_case_binary_time = measure_performance(binary_search, len(worst_case_input))

# Plot the results including the worst-case scenario
array_sizes.append(len(worst_case_input))
linear_search_times.append(measure_performance(linear_search, len(worst_case_input)))
binary_search_times.append(worst_case_binary_time)
...
plt.title('Performance Comparison of Linear and Binary Search (Including Worst Case)')
